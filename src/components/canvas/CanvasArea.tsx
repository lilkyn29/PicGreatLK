...
export function CanvasArea() {
  ...
  const { setCanvas, setImage, image, canvas, isCropping, setIsCropping, isDrawing, isErasing, brushColor, brushSize, setSelectedObject } = useEditorStore();
